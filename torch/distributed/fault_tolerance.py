            ...
            while True:
                try:
                    ...
                    for _ in range(ts, config.num_iteration):
                        ...
                        if ts._value != 0 and ts._value == consensus_value and get_rank() == 104:
                        ...
                        # for experiment:
                        if ts._value == 150 and get_rank() == 104 and not os.path.exists("./temp.flag"):
                        ...
                        if ts % config.print_freq == 0 and get_rank() in [0, 8, 104]:
                            write = "{} {:.2f} {:.2f} {:.2f} \n".format(
