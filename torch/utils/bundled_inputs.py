...
class InflatableArg(NamedTuple):
    """ Helper type for bundled inputs.
        ...
        data into the appropriate input. It can use 'value' as an input to the function str.
        It must result in a value of the same type as 'value'. The function name should be
        the formatable part of the string.
...
def _get_inflate_helper_fn_name(
    ...
    return f"_inflate_helper_for_arg_{arg_idx}_for_{function_name}_input_{input_idx}"
