    ...
    {Operator(
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::_fft_with_size(
                 ...
                 (std::move(peek(stack, 8, 9))).toIntVector()
             );
             drop(stack, 9);
             pack(stack, std::move(result_));
             return 0;
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::batch_norm_elemt_out(
                 out,
                 (std::move(peek(stack, 0, 7))).toTensor(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             auto out = (std::move(peek(stack, 2, 3))).toTensor();
             auto result_ = at::bitwise_and_out(
                 out,
                 (std::move(peek(stack, 0, 3))).toTensor(),
                 (std::move(peek(stack, 1, 3))).toTensor()
             );
     ...
     Operator(
         ...
         [](Stack & stack) {
             auto self = (std::move(peek(stack, 0, 2))).toTensor();
             auto result_ = (self).bitwise_xor_(
                 (std::move(peek(stack, 1, 2))).toTensor()
             );
             drop(stack, 2);
             pack(stack, std::move(result_));
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::convolution_backward_overrideable(
                 ...
                 (std::move(peek(stack, 7, 10))).toIntVector(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::cudnn_convolution_backward(
                 ...
                 as_bool_array<2>((std::move(peek(stack, 9, 10))).toBoolList())
             );
             drop(stack, 10);
             pack(stack, std::move(result_));
             return 0;
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::cudnn_convolution_transpose_backward(
                 ...
                 (std::move(peek(stack, 9, 11))).toBool(),
                 as_bool_array<2>((std::move(peek(stack, 10, 11))).toBoolList())
             );
             drop(stack, 11);
             pack(stack, std::move(result_));
             return 0;
     ...
     Operator(
         ...
         [](Stack & stack) {
             auto self = (std::move(peek(stack, 0, 2))).toTensor();
             auto result_ = (self).logical_and_(
                 (std::move(peek(stack, 1, 2))).toTensor()
             );
             drop(stack, 2);
             pack(stack, std::move(result_));
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::lstm(
                 (std::move(peek(stack, 0, 9))).toTensor(),
                 (std::move(peek(stack, 1, 9))).toTensorVector(),
                 (std::move(peek(stack, 2, 9))).toTensorVector(),
                 (std::move(peek(stack, 3, 9))).toBool(),
                 (std::move(peek(stack, 4, 9))).toInt(),
                 (std::move(peek(stack, 5, 9))).toDouble(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             auto out = (std::move(peek(stack, 6, 7))).toTensor();
             auto result_ = at::slow_conv3d_out(
                 out,
                 (std::move(peek(stack, 0, 7))).toTensor(),
                 (std::move(peek(stack, 1, 7))).toTensor(),
                 (std::move(peek(stack, 2, 7))).toIntVector(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::upsample_trilinear3d_backward(
                 ...
                 (std::move(peek(stack, 4, 7))).toOptional<double>(),
                 (std::move(peek(stack, 5, 7))).toOptional<double>(),
                 (std::move(peek(stack, 6, 7))).toOptional<double>()
             );
             drop(stack, 7);
             pack(stack, std::move(result_));
             return 0;
