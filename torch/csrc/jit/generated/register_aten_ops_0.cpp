    ...
    {Operator(
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::_batch_norm_impl_index_backward(
                 (std::move(peek(stack, 0, 12))).toInt(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             #else
                 auto result_ = torch::__empty_affine_quantized((std::move(peek(stack, 0, 8))).toIntVector(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::_nnpack_spatial_convolution_backward_input(
                 ...
                 (std::move(peek(stack, 3, 4))).toIntVector()
             );
             drop(stack, 4);
             pack(stack, std::move(result_));
             return 0;
     ...
     Operator(
         ...
         [](Stack & stack) {
             auto out = (std::move(peek(stack, 2, 3))).toTensor();
             auto result_ = at::bitwise_or_out(
                 out,
                 (std::move(peek(stack, 0, 3))).toTensor(),
                 (std::move(peek(stack, 1, 3))).toTensor()
             );
     ...
     Operator(
         ...
         [](Stack & stack) {
             auto out = (std::move(peek(stack, 2, 3))).toTensor();
             auto result_ = at::bitwise_xor_out(
                 out,
                 (std::move(peek(stack, 0, 3))).toTensor(),
                 (std::move(peek(stack, 1, 3))).toTensor()
             );
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             options);
             #else
                 auto result_ = torch::_full((std::move(peek(stack, 0, 6))).toIntVector(),
             (std::move(peek(stack, 1, 6))).toScalar(),
             at::typeMetaToScalarType(options.dtype()),
             options.layout(), options.device(), options.pinned_memory(), options.requires_grad());
             #endif
     ...
     Operator(
         ...
         [](Stack & stack) {
             auto out = (std::move(peek(stack, 2, 3))).toTensor();
             auto result_ = at::logical_and_out(
                 out,
                 (std::move(peek(stack, 0, 3))).toTensor(),
                 (std::move(peek(stack, 1, 3))).toTensor()
             );
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::quantized_lstm(
                 ...
                 (std::move(peek(stack, 2, 11))).toTensorVector(),
                 (std::move(peek(stack, 3, 11))).toTensorVector(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::quantized_lstm(
                 (std::move(peek(stack, 0, 11))).toTensor(),
                 (std::move(peek(stack, 1, 11))).toTensorVector(),
                 (std::move(peek(stack, 2, 11))).toTensorVector(),
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             options);
             #else
                 auto result_ = torch::_randn((std::move(peek(stack, 0, 5))).toIntVector(),
             at::typeMetaToScalarType(options.dtype()),
             options.layout(), options.device(), options.pinned_memory(), options.requires_grad());
             #endif
             drop(stack, 5);
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::slow_conv3d_forward(
                 (std::move(peek(stack, 0, 6))).toTensor(),
                 (std::move(peek(stack, 1, 6))).toTensor(),
                 (std::move(peek(stack, 2, 6))).toIntVector(),
                 toOptionalTensor((std::move(peek(stack, 3, 6)))),
     ...
     Operator(
         ...
         [](Stack & stack) {
             ...
             auto result_ = at::upsample_nearest1d(
                 (std::move(peek(stack, 0, 3))).toTensor(),
                 (std::move(peek(stack, 1, 3))).toIntVector(),
                 (std::move(peek(stack, 2, 3))).toOptional<double>()
             );
             drop(stack, 3);
             pack(stack, std::move(result_));
             return 0;
