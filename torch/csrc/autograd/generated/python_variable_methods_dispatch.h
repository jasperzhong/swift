...
inline Tensor dispatch_diagonal(Tensor & self, Dimname outdim, Dimname dim1, Dimname dim2, int64_t offset) {
...
inline Tensor dispatch_logical_and(Tensor & self, const Tensor & other) {


  pybind11::gil_scoped_release no_gil;
  return self.logical_and(other);
}
inline Tensor dispatch_logical_and_(Tensor & self, const Tensor & other) {
...
inline Tensor dispatch_logical_or(Tensor & self, const Tensor & other) {


  pybind11::gil_scoped_release no_gil;
  return self.logical_or(other);
}
inline Tensor dispatch_logical_or_(Tensor & self, const Tensor & other) {
...
inline Tensor dispatch_new_empty(Tensor & self, IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
...
inline Tensor dispatch_new_full(Tensor & self, IntArrayRef size, Scalar fill_value, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device).layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return self.new_full(size, fill_value, options);
}
inline Tensor dispatch_new_zeros(Tensor & self, IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device).layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
