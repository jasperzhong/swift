...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::is_leaf", ""}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::output_nr", ""}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::_version", ""}).value();
    return op.callUnboxed<int64_t, const Tensor &>(const_cast<Tensor&>(*this));
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::requires_grad_", ""}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::rename_", ""}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::rename", ""}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::align_to", ""}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::align_to", "ellipsis_idx"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::refine_names", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &, DimnameList>(const_cast<Tensor&>(*this), names);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::unflatten", "Dimname"}).value();
...
inline Tensor Tensor::unflatten(int64_t dim, IntArrayRef sizes, DimnameList names) const {
    ...
    return TypeDefault::unflatten(const_cast<Tensor&>(*this), dim, sizes, names);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::unflatten", "int"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::angle", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &>(const_cast<Tensor&>(*this));
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::real", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &>(const_cast<Tensor&>(*this));
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::imag", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &>(const_cast<Tensor&>(*this));
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::conj", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &>(const_cast<Tensor&>(*this));
#endif
}
...
inline Tensor Tensor::all(Dimname dim, bool keepdim) const {
    ...
    return TypeDefault::all(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::all", "dimname"}).value();
...
inline Tensor Tensor::any(Dimname dim, bool keepdim) const {
    ...
    return TypeDefault::any(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::any", "dimname"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Dimname, bool>(const_cast<Tensor&>(*this), dim, keepdim);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::logical_and", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &, const Tensor &>(const_cast<Tensor&>(*this), other);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::logical_and_", ""}).value();
    return op.callUnboxed<Tensor &, Tensor &, const Tensor &>(const_cast<Tensor&>(*this), other);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::logical_or", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &, const Tensor &>(const_cast<Tensor&>(*this), other);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::logical_or_", ""}).value();
    return op.callUnboxed<Tensor &, Tensor &, const Tensor &>(const_cast<Tensor&>(*this), other);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::contiguous", ""}).value();
...
inline Tensor Tensor::cumsum(Dimname dim, c10::optional<ScalarType> dtype) const {
    ...
    return TypeDefault::cumsum(const_cast<Tensor&>(*this), dim, dtype);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::cumsum", "dimname"}).value();
...
inline Tensor Tensor::cumprod(Dimname dim, c10::optional<ScalarType> dtype) const {
    ...
    return TypeDefault::cumprod(const_cast<Tensor&>(*this), dim, dtype);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::cumprod", "dimname"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Dimname, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dim, dtype);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::diagonal", "Dimname"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::flatten", "named_out_dim"}).value();
...
inline Tensor Tensor::flatten(Dimname start_dim, Dimname end_dim, Dimname out_dim) const {
    ...
    return TypeDefault::flatten(const_cast<Tensor&>(*this), start_dim, end_dim, out_dim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::flatten", "using_names"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::flatten", "DimnameList"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index", "Tensor"}).value();
...
inline Tensor & Tensor::index_copy_(Dimname dim, const Tensor & index, const Tensor & source) const {
    ...
    return TypeDefault::index_copy_(const_cast<Tensor&>(*this), dim, index, source);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_copy_", "dimname"}).value();
...
inline Tensor Tensor::index_copy(Dimname dim, const Tensor & index, const Tensor & source) const {
    ...
    return TypeDefault::index_copy(const_cast<Tensor&>(*this), dim, index, source);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_copy", "dimname"}).value();
...
inline std::tuple<Tensor,Tensor> Tensor::kthvalue(int64_t k, Dimname dim, bool keepdim) const {
    ...
    return TypeDefault::kthvalue(const_cast<Tensor&>(*this), k, dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::kthvalue", "dimname"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::log_softmax", "int"}).value();
    return op.callUnboxed<Tensor, const Tensor &, int64_t, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dim, dtype);
#endif
}
#ifdef BUILD_NAMEDTENSOR
inline Tensor Tensor::log_softmax(Dimname dim, c10::optional<ScalarType> dtype) const {
    ...
    return TypeDefault::log_softmax(const_cast<Tensor&>(*this), dim, dtype);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::log_softmax", "Dimname"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Dimname, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dim, dtype);
#endif
}
#endif
...
inline Tensor Tensor::logsumexp(DimnameList dim, bool keepdim) const {
    ...
    return TypeDefault::logsumexp(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::logsumexp", "names"}).value();
...
inline std::tuple<Tensor,Tensor> Tensor::max(Dimname dim, bool keepdim) const {
    ...
    return TypeDefault::max(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::max", "names_dim"}).value();
...
inline Tensor Tensor::max_values(DimnameList dim, bool keepdim) const {
    ...
    return TypeDefault::max_values(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::max_values", "names"}).value();
    return op.callUnboxed<Tensor, const Tensor &, DimnameList, bool>(const_cast<Tensor&>(*this), dim, keepdim);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::mean", ""}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::mean", "dim"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::mean", "names_dim"}).value();
...
inline std::tuple<Tensor,Tensor> Tensor::median(Dimname dim, bool keepdim) const {
    ...
    return TypeDefault::median(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::median", "names_dim"}).value();
    return op.callUnboxed<std::tuple<Tensor,Tensor>, const Tensor &, Dimname, bool>(const_cast<Tensor&>(*this), dim, keepdim);
#endif
}
#endif
...
inline std::tuple<Tensor,Tensor> Tensor::min(Dimname dim, bool keepdim) const {
    ...
    return TypeDefault::min(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::min", "names_dim"}).value();
    return op.callUnboxed<std::tuple<Tensor,Tensor>, const Tensor &, Dimname, bool>(const_cast<Tensor&>(*this), dim, keepdim);
#endif
}
#endif
...
inline Tensor Tensor::min_values(DimnameList dim, bool keepdim) const {
    ...
    return TypeDefault::min_values(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::min_values", "names"}).value();
    return op.callUnboxed<Tensor, const Tensor &, DimnameList, bool>(const_cast<Tensor&>(*this), dim, keepdim);
#endif
}
#endif
...
inline std::tuple<Tensor,Tensor> Tensor::mode(Dimname dim, bool keepdim) const {
    ...
    return TypeDefault::mode(const_cast<Tensor&>(*this), dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::mode", "dimname"}).value();
    return op.callUnboxed<std::tuple<Tensor,Tensor>, const Tensor &, Dimname, bool>(const_cast<Tensor&>(*this), dim, keepdim);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::softmax", "int"}).value();
    return op.callUnboxed<Tensor, const Tensor &, int64_t, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dim, dtype);
#endif
}
#ifdef BUILD_NAMEDTENSOR
inline Tensor Tensor::softmax(Dimname dim, c10::optional<ScalarType> dtype) const {
    ...
    return TypeDefault::softmax(const_cast<Tensor&>(*this), dim, dtype);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::softmax", "Dimname"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Dimname, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dim, dtype);
#endif
}
#endif
...
inline Tensor Tensor::squeeze(Dimname dim) const {
    ...
    return TypeDefault::squeeze(const_cast<Tensor&>(*this), dim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::squeeze", "dimname"}).value();
...
inline Tensor & Tensor::squeeze_(Dimname dim) const {
    ...
    return TypeDefault::squeeze_(const_cast<Tensor&>(*this), dim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::squeeze_", "dimname"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::sum", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dtype);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::sum", "dim_IntList"}).value();
    return op.callUnboxed<Tensor, const Tensor &, IntArrayRef, bool, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dim, keepdim, dtype);
#endif
}
#ifdef BUILD_NAMEDTENSOR
inline Tensor Tensor::sum(DimnameList dim, bool keepdim, c10::optional<ScalarType> dtype) const {
    ...
    return TypeDefault::sum(const_cast<Tensor&>(*this), dim, keepdim, dtype);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::sum", "dim_DimnameList"}).value();
    return op.callUnboxed<Tensor, const Tensor &, DimnameList, bool, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dim, keepdim, dtype);
#endif
}
#endif
...
inline Tensor Tensor::std(DimnameList dim, bool unbiased, bool keepdim) const {
    ...
    return TypeDefault::std(const_cast<Tensor&>(*this), dim, unbiased, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::std", "names_dim"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::prod", ""}).value();
    return op.callUnboxed<Tensor, const Tensor &, c10::optional<ScalarType>>(const_cast<Tensor&>(*this), dtype);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::prod", "dim_int"}).value();
...
inline Tensor Tensor::prod(Dimname dim, bool keepdim, c10::optional<ScalarType> dtype) const {
    ...
    return TypeDefault::prod(const_cast<Tensor&>(*this), dim, keepdim, dtype);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::prod", "dim_Dimname"}).value();
...
inline Tensor Tensor::transpose(Dimname dim0, Dimname dim1) const {
    ...
    return TypeDefault::transpose(const_cast<Tensor&>(*this), dim0, dim1);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::transpose", "Dimname"}).value();
...
inline Tensor Tensor::var(DimnameList dim, bool unbiased, bool keepdim) const {
    ...
    return TypeDefault::var(const_cast<Tensor&>(*this), dim, unbiased, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::var", "names_dim"}).value();
    return op.callUnboxed<Tensor, const Tensor &, DimnameList, bool, bool>(const_cast<Tensor&>(*this), dim, unbiased, keepdim);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::norm", "ScalarOpt_dtype"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::norm", "ScalarOpt_dim_dtype"}).value();
...
inline Tensor Tensor::norm(c10::optional<Scalar> p, DimnameList dim, bool keepdim, ScalarType dtype) const {
    ...
    return TypeDefault::norm(const_cast<Tensor&>(*this), p, dim, keepdim, dtype);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::norm", "names_ScalarOpt_dim_dtype"}).value();
...
inline Tensor Tensor::norm(c10::optional<Scalar> p, DimnameList dim, bool keepdim) const {
    ...
    return TypeDefault::norm(const_cast<Tensor&>(*this), p, dim, keepdim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::norm", "names_ScalarOpt_dim"}).value();
...
inline std::vector<Tensor> Tensor::unbind(Dimname dim) const {
    ...
    return TypeDefault::unbind(const_cast<Tensor&>(*this), dim);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::unbind", "Dimname"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::q_per_channel_axis", ""}).value();
    return op.callUnboxed<int64_t, const Tensor &>(const_cast<Tensor&>(*this));
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::to", "device"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::to", "dtype"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::set_", "source_Storage"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::set_", "source_Storage_storage_offset"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::set_quantizer_", ""}).value();
...
inline Tensor Tensor::index_add(Dimname dim, const Tensor & index, const Tensor & source) const {
    ...
    return TypeDefault::index_add(const_cast<Tensor&>(*this), dim, index, source);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_add", "dimname"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Dimname, const Tensor &, const Tensor &>(const_cast<Tensor&>(*this), dim, index, source);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill_", "int_Scalar"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill", "int_Scalar"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill_", "int_Tensor"}).value();
...
inline Tensor Tensor::index_fill(int64_t dim, const Tensor & index, const Tensor & value) const {
    ...
    return TypeDefault::index_fill(const_cast<Tensor&>(*this), dim, index, value);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill", "int_Tensor"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill_", "Dimname_Scalar"}).value();
...
inline Tensor & Tensor::index_fill_(Dimname dim, const Tensor & index, const Tensor & value) const {
    ...
    return TypeDefault::index_fill_(const_cast<Tensor&>(*this), dim, index, value);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill_", "Dimname_Tensor"}).value();
...
inline Tensor Tensor::index_fill(Dimname dim, const Tensor & index, Scalar value) const {
    ...
    return TypeDefault::index_fill(const_cast<Tensor&>(*this), dim, index, value);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill", "Dimname_Scalar"}).value();
...
inline Tensor Tensor::index_fill(Dimname dim, const Tensor & index, const Tensor & value) const {
    ...
    return TypeDefault::index_fill(const_cast<Tensor&>(*this), dim, index, value);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_fill", "Dimname_Tensor"}).value();
...
inline Tensor Tensor::scatter(Dimname dim, const Tensor & index, const Tensor & src) const {
    ...
    return TypeDefault::scatter(const_cast<Tensor&>(*this), dim, index, src);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::scatter", "dimname_src"}).value();
...
inline Tensor Tensor::scatter(Dimname dim, const Tensor & index, Scalar value) const {
    ...
    return TypeDefault::scatter(const_cast<Tensor&>(*this), dim, index, value);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::scatter", "dimname_value"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Dimname, const Tensor &, Scalar>(const_cast<Tensor&>(*this), dim, index, value);
#endif
}
#endif
...
inline Tensor Tensor::scatter_add(Dimname dim, const Tensor & index, const Tensor & src) const {
    ...
    return TypeDefault::scatter_add(const_cast<Tensor&>(*this), dim, index, src);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::scatter_add", "dimname"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Dimname, const Tensor &, const Tensor &>(const_cast<Tensor&>(*this), dim, index, src);
#endif
}
#endif
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::bitwise_xor", "Scalar"}).value();
    return op.callUnboxed<Tensor, const Tensor &, Scalar>(const_cast<Tensor&>(*this), other);
#endif
}
inline Tensor Tensor::bitwise_xor(const Tensor & other) const {
    ...
    return TypeDefault::bitwise_xor(const_cast<Tensor&>(*this), other);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::bitwise_xor", "Tensor"}).value();
    return op.callUnboxed<Tensor, const Tensor &, const Tensor &>(const_cast<Tensor&>(*this), other);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::bitwise_xor_", "Scalar"}).value();
    return op.callUnboxed<Tensor &, Tensor &, Scalar>(const_cast<Tensor&>(*this), other);
#endif
}
inline Tensor & Tensor::bitwise_xor_(const Tensor & other) const {
    ...
    return TypeDefault::bitwise_xor_(const_cast<Tensor&>(*this), other);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::bitwise_xor_", "Tensor"}).value();
    return op.callUnboxed<Tensor &, Tensor &, const Tensor &>(const_cast<Tensor&>(*this), other);
#endif
}
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::index_select", "dimname"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::gather", "dimname"}).value();
...
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::sort", "dimname"}).value();
...
inline Tensor Tensor::argsort(Dimname dim, bool descending) const {
    ...
    return TypeDefault::argsort(const_cast<Tensor&>(*this), dim, descending);
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton().findSchema({"aten::argsort", "dimname"}).value();
...
inline Tensor Tensor::any() const {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(type_set()))) {
        ...
        case Backend::SparseCPU:
            ...
            break;
        default:
            AT_ERROR("any not implemented for ", at::toString(type_set()));
    }
#else
