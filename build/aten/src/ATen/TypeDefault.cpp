...
auto registerer = torch::RegisterOperators()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyCatchAllKernel<Tensor & (Tensor &, const Tensor &, Scalar), &TypeDefault::leaky_relu_out>()
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::leaky_relu(Tensor self, Scalar negative_slope=0.01) -> Tensor")
    .catchAllKernel<Tensor (const Tensor &, Scalar)>(&TypeDefault::leaky_relu)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyCatchAllKernel<Tensor & (Tensor &, Scalar), &TypeDefault::leaky_relu_>()
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
