...
#ifdef USE_STATIC_DISPATCH
    at::AutoNonVariableTypeMode _var_guard(true);
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
    
        default:
            AT_ERROR("_cudnn_init_dropout_state not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor _empty(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<MemoryFormat> memory_format) {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
        ...
        case Backend::SparseCPU:
            ...
            break;
        default:
            AT_ERROR("empty not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor __empty_affine_quantized(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, double scale, int64_t zero_point, c10::optional<MemoryFormat> memory_format) {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
        ...
        case Backend::QuantizedCPU:
            ...
            break;
        default:
            AT_ERROR("_empty_affine_quantized not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
#ifdef USE_STATIC_DISPATCH
    at::AutoNonVariableTypeMode _var_guard(true);
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(scales, zero_points, dtype, device, layout, pin_memory)))) {
        case Backend::CPU:
        ...
        case Backend::QuantizedCPU:
            ...
            break;
        default:
            AT_ERROR("_empty_per_channel_affine_quantized not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(scales, zero_points, dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(scales, zero_points, dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(self, dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor _empty_strided(IntArrayRef size, IntArrayRef stride, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory) {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("empty_strided not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor _from_file(std::string filename, c10::optional<bool> shared, c10::optional<int64_t> size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory) {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("from_file not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(indices, values, dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor __sparse_coo_tensor_with_dims(int64_t sparse_dim, int64_t dense_dim, IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory) {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
        case Backend::SparseCPU:
            ...
            break;
        default:
            AT_ERROR("_sparse_coo_tensor_with_dims not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
#ifdef USE_STATIC_DISPATCH
    at::AutoNonVariableTypeMode _var_guard(true);
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(indices, values, dtype, device, layout, pin_memory)))) {
        case Backend::SparseCPU:
            ...
            break;
        default:
            AT_ERROR("_sparse_coo_tensor_with_dims_and_tensors not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(indices, values, dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(indices, values, dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor _tril_indices(int64_t row, int64_t col, int64_t offset, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory) {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("tril_indices not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor _triu_indices(int64_t row, int64_t col, int64_t offset, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory) {
    ...
    switch(tensorTypeIdToBackend(c10::impl::dispatchTypeId(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("triu_indices not implemented for ", at::toString(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory)));
    }
#else
    globalLegacyTypeDispatch().initForTensorTypeSet(c10::detail::multi_dispatch_tensor_type_set(dtype, device, layout, pin_memory));
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
...
static inline Tensor & upsample_linear1d_out(Tensor & out, const Tensor & self, IntArrayRef output_size, bool align_corners) {
    ...
    return op.callUnboxed<Tensor &, Tensor &, const Tensor &, IntArrayRef, bool>(out, self, output_size, align_corners);
#endif
}
static inline Tensor upsample_linear1d(const Tensor & self, IntArrayRef output_size, bool align_corners) {
#ifdef USE_STATIC_DISPATCH
    ...
    return op.callUnboxed<Tensor, const Tensor &, IntArrayRef, bool>(self, output_size, align_corners);
#endif
}
static inline Tensor & upsample_linear1d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size, bool align_corners) {
#ifdef USE_STATIC_DISPATCH
    ...
    return op.callUnboxed<Tensor &, Tensor &, const Tensor &, IntArrayRef, IntArrayRef, bool>(grad_input, grad_output, output_size, input_size, align_corners);
#endif
}
static inline Tensor upsample_linear1d_backward(const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size, bool align_corners) {
#ifdef USE_STATIC_DISPATCH
    ...
    return op.callUnboxed<Tensor, const Tensor &, IntArrayRef, IntArrayRef, bool>(grad_output, output_size, input_size, align_corners);
#endif
}
static inline Tensor & upsample_bilinear2d_out(Tensor & out, const Tensor & self, IntArrayRef output_size, bool align_corners) {
#ifdef USE_STATIC_DISPATCH
...
static inline Tensor & upsample_nearest1d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size) {
    ...
    return op.callUnboxed<Tensor &, Tensor &, const Tensor &, IntArrayRef, IntArrayRef>(grad_input, grad_output, output_size, input_size);
#endif
}
static inline Tensor upsample_nearest1d_backward(const Tensor & grad_output, IntArrayRef output_size, IntArrayRef input_size) {
#ifdef USE_STATIC_DISPATCH
    ...
    return op.callUnboxed<Tensor, const Tensor &, IntArrayRef, IntArrayRef>(grad_output, output_size, input_size);
#endif
}
static inline Tensor & upsample_nearest2d_out(Tensor & out, const Tensor & self, IntArrayRef output_size) {
#ifdef USE_STATIC_DISPATCH
