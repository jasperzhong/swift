...
// using TTSparseLengthsSumOp =
//     CPUTTSparseLengthsReductionOp<float, TensorTypes<float, float>, 0, 0>;
...
// REGISTER_CPU_OPERATOR(TTSparseLengthsSum, TTSparseLengthsSumOp);
